...
describe("tag scanner", () => {
  it.each([
    ...
    ["#O‘Brien #foo-'bar #foo'1️⃣ #A‍'B", ["O‘Brien", "foo-", "foo", "A"]],
    ["#foo,bar #price€ #€budget #v²", ["foo,bar", "price", "v"]],
    ["#Books/笔记的方法/2.记录篇/2.标签分类 ", ["Books/笔记的方法/2.记录篇/2.标签分类"]],
    ["#Books/九宫格写作法/01用“九宫格×自问自答”变身写作达人 ", ["Books/九宫格写作法/01用“九宫格×自问自答”变身写作达人"]],
