...
/**
 * @generated from message memos.api.v1.UserProfileStats
 */
export type UserProfileStats = Message<"memos.api.v1.UserProfileStats"> & {
  /**
   ...
   *
   * @generated from field: int32 total_memo_count = 2;
   */
  totalMemoCount: number;
   ...
   *
   * @generated from field: int32 total_tag_count = 3;
   */
   ...
   *
   * @generated from field: int32 active_day_count = 4;
   */
   ...
   *
   * @generated from field: int32 year_memo_count = 5;
   */
  yearMemoCount: number;
   ...
   *
   * @generated from field: int32 longest_streak = 7;
   */
   ...
   *
   * @generated from field: bool includes_all_memos = 8;
   */
  includesAllMemos: boolean;

  /**
   * Daily aggregate activity counts. Does not expose memo ids, content, tags, locations, or timestamps.
   *
   * @generated from field: repeated memos.api.v1.UserProfileStats.DailyActivity daily_activity = 9;
   */
  dailyActivity: UserProfileStats_DailyActivity[];
};

/**
 * Describes the message memos.api.v1.UserProfileStats.
 * Use `create(UserProfileStatsSchema)` to create a new message.
 */
export const UserProfileStatsSchema: GenMessage<UserProfileStats> = /*@__PURE__*/
  messageDesc(file_api_v1_user_service, 11);

/**
 * @generated from message memos.api.v1.UserProfileStats.DailyActivity
 */
export type UserProfileStats_DailyActivity = Message<"memos.api.v1.UserProfileStats.DailyActivity"> & {
  /**
...
/**
 * Describes the message memos.api.v1.UserProfileStats.DailyActivity.
 * Use `create(UserProfileStats_DailyActivitySchema)` to create a new message.
 */
export const UserProfileStats_DailyActivitySchema: GenMessage<UserProfileStats_DailyActivity> = /*@__PURE__*/
  messageDesc(file_api_v1_user_service, 11, 0);

/**
 * @generated from message memos.api.v1.GetUserProfileStatsRequest
 */
export type GetUserProfileStatsRequest = Message<"memos.api.v1.GetUserProfileStatsRequest"> & {
  /**
   * Required. The resource name of the user.
   * Format: users/{user}
   *
...
/**
 * Describes the message memos.api.v1.GetUserProfileStatsRequest.
 * Use `create(GetUserProfileStatsRequestSchema)` to create a new message.
 */
export const GetUserProfileStatsRequestSchema: GenMessage<GetUserProfileStatsRequest> = /*@__PURE__*/
...
export type UserSetting_GeneralSetting = Message<"memos.api.v1.UserSetting.GeneralSetting"> & {
   ...
   *
   * @generated from field: int32 calendar_day_start = 6;
   */
   ...
   *
   * @generated from field: int32 calendar_day_end = 7;
   */
   ...
   * Defaults to true.
   *
   * @generated from field: bool show_comment_preview = 8;
   */
   ...
   *
   * @generated from field: bool comment_indicator_on_hover = 9;
   */
  commentIndicatorOnHover: boolean;

  /**
   * Whether the public Profile page may show aggregate stats from all normal memos.
   *
   * @generated from field: bool show_full_profile_stats = 10;
   */
  showFullProfileStats: boolean;
};
...
export type UserNotification = Message<"memos.api.v1.UserNotification"> & {
  ...
  payload: {
    ...
    /**
     * @generated from field: memos.api.v1.UserNotification.ScheduleReminderPayload schedule_reminder = 9;
     */
    value: UserNotification_ScheduleReminderPayload;
...
/**
 * @generated from message memos.api.v1.UserNotification.ScheduleReminderPayload
 */
export type UserNotification_ScheduleReminderPayload = Message<"memos.api.v1.UserNotification.ScheduleReminderPayload"> & {
  /**
   * The scheduled memo.
   * Format: memos/{memo}
   *
   ...
   *
   * @generated from field: google.protobuf.Timestamp occurrence_time = 3;
   */
  occurrenceTime?: Timestamp | undefined;

  /**
   * How long before occurrence_time this reminder was sent.
   *
   * @generated from field: google.protobuf.Duration reminder_offset = 4;
   */
  reminderOffset?: Duration | undefined;
};

/**
 * Describes the message memos.api.v1.UserNotification.ScheduleReminderPayload.
 * Use `create(UserNotification_ScheduleReminderPayloadSchema)` to create a new message.
 */
export const UserNotification_ScheduleReminderPayloadSchema: GenMessage<UserNotification_ScheduleReminderPayload> = /*@__PURE__*/
  messageDesc(file_api_v1_user_service, 40, 2);
...
export enum UserNotification_Type {
  ...
  /**
   * @generated from enum value: SCHEDULE_REMINDER = 3;
   */
  SCHEDULE_REMINDER = 3,
}
...
/**
 * @generated from message memos.api.v1.UserPushNotificationConfig
 */
export type UserPushNotificationConfig = Message<"memos.api.v1.UserPushNotificationConfig"> & {
  /**
...
/**
 * Describes the message memos.api.v1.UserPushNotificationConfig.
 * Use `create(UserPushNotificationConfigSchema)` to create a new message.
 */
export const UserPushNotificationConfigSchema: GenMessage<UserPushNotificationConfig> = /*@__PURE__*/
  messageDesc(file_api_v1_user_service, 45);

/**
 * @generated from message memos.api.v1.GetUserPushNotificationConfigRequest
 */
export type GetUserPushNotificationConfigRequest = Message<"memos.api.v1.GetUserPushNotificationConfigRequest"> & {
  /**
   * The parent user resource.
   * Format: users/{user}
   *
...
/**
 * Describes the message memos.api.v1.GetUserPushNotificationConfigRequest.
 * Use `create(GetUserPushNotificationConfigRequestSchema)` to create a new message.
 */
export const GetUserPushNotificationConfigRequestSchema: GenMessage<GetUserPushNotificationConfigRequest> = /*@__PURE__*/
  messageDesc(file_api_v1_user_service, 46);

/**
 * @generated from message memos.api.v1.UserPushSubscription
 */
export type UserPushSubscription = Message<"memos.api.v1.UserPushSubscription"> & {
  /**
...
/**
 * Describes the message memos.api.v1.UserPushSubscription.
 * Use `create(UserPushSubscriptionSchema)` to create a new message.
 */
export const UserPushSubscriptionSchema: GenMessage<UserPushSubscription> = /*@__PURE__*/
  messageDesc(file_api_v1_user_service, 47);

/**
 * @generated from message memos.api.v1.ListUserPushSubscriptionsRequest
 */
export type ListUserPushSubscriptionsRequest = Message<"memos.api.v1.ListUserPushSubscriptionsRequest"> & {
  /**
   * The parent user resource.
   * Format: users/{user}
   *
...
/**
 * Describes the message memos.api.v1.ListUserPushSubscriptionsRequest.
 * Use `create(ListUserPushSubscriptionsRequestSchema)` to create a new message.
 */
export const ListUserPushSubscriptionsRequestSchema: GenMessage<ListUserPushSubscriptionsRequest> = /*@__PURE__*/
  messageDesc(file_api_v1_user_service, 48);

/**
 * @generated from message memos.api.v1.ListUserPushSubscriptionsResponse
 */
export type ListUserPushSubscriptionsResponse = Message<"memos.api.v1.ListUserPushSubscriptionsResponse"> & {
  /**
   * @generated from field: repeated memos.api.v1.UserPushSubscription subscriptions = 1;
   */
  subscriptions: UserPushSubscription[];
};

/**
 * Describes the message memos.api.v1.ListUserPushSubscriptionsResponse.
 * Use `create(ListUserPushSubscriptionsResponseSchema)` to create a new message.
 */
export const ListUserPushSubscriptionsResponseSchema: GenMessage<ListUserPushSubscriptionsResponse> = /*@__PURE__*/
  messageDesc(file_api_v1_user_service, 49);

/**
 * @generated from message memos.api.v1.CreateUserPushSubscriptionRequest
 */
export type CreateUserPushSubscriptionRequest = Message<"memos.api.v1.CreateUserPushSubscriptionRequest"> & {
  /**
   * The parent user resource.
   * Format: users/{user}
   *
  ...
  /**
   * @generated from field: memos.api.v1.UserPushSubscription subscription = 2;
   */
  subscription?: UserPushSubscription | undefined;
};

/**
 * Describes the message memos.api.v1.CreateUserPushSubscriptionRequest.
 * Use `create(CreateUserPushSubscriptionRequestSchema)` to create a new message.
 */
export const CreateUserPushSubscriptionRequestSchema: GenMessage<CreateUserPushSubscriptionRequest> = /*@__PURE__*/
  messageDesc(file_api_v1_user_service, 50);

/**
 * @generated from message memos.api.v1.DeleteUserPushSubscriptionRequest
 */
export type DeleteUserPushSubscriptionRequest = Message<"memos.api.v1.DeleteUserPushSubscriptionRequest"> & {
  /**
   * Format: users/{user}/pushSubscriptions/{push_subscription}
   *
   * @generated from field: string name = 1;
...
/**
 * Describes the message memos.api.v1.DeleteUserPushSubscriptionRequest.
 * Use `create(DeleteUserPushSubscriptionRequestSchema)` to create a new message.
 */
export const DeleteUserPushSubscriptionRequestSchema: GenMessage<DeleteUserPushSubscriptionRequest> = /*@__PURE__*/
  messageDesc(file_api_v1_user_service, 51);

/**
 * @generated from message memos.api.v1.TestUserPushNotificationRequest
 */
export type TestUserPushNotificationRequest = Message<"memos.api.v1.TestUserPushNotificationRequest"> & {
  /**
   * The parent user resource.
   * Format: users/{user}
   *
...
/**
 * Describes the message memos.api.v1.TestUserPushNotificationRequest.
 * Use `create(TestUserPushNotificationRequestSchema)` to create a new message.
 */
export const TestUserPushNotificationRequestSchema: GenMessage<TestUserPushNotificationRequest> = /*@__PURE__*/
...
export const UserService: GenService<{
   ...
   *
   * @generated from rpc memos.api.v1.UserService.GetUserProfileStats
   */
  getUserProfileStats: {
    methodKind: "unary";
    input: typeof GetUserProfileStatsRequestSchema;
    output: typeof UserProfileStatsSchema;
  },
  /**
   ...
   *
   * @generated from rpc memos.api.v1.UserService.GetUserPushNotificationConfig
   */
  getUserPushNotificationConfig: {
    methodKind: "unary";
    input: typeof GetUserPushNotificationConfigRequestSchema;
    output: typeof UserPushNotificationConfigSchema;
  },
  /**
   * ListUserPushSubscriptions lists browser push subscriptions for a user.
   *
   * @generated from rpc memos.api.v1.UserService.ListUserPushSubscriptions
   */
  listUserPushSubscriptions: {
    methodKind: "unary";
    input: typeof ListUserPushSubscriptionsRequestSchema;
    output: typeof ListUserPushSubscriptionsResponseSchema;
  },
  /**
   * CreateUserPushSubscription creates or refreshes a browser push subscription.
   *
   * @generated from rpc memos.api.v1.UserService.CreateUserPushSubscription
   */
  createUserPushSubscription: {
    methodKind: "unary";
    input: typeof CreateUserPushSubscriptionRequestSchema;
    output: typeof UserPushSubscriptionSchema;
  },
  /**
   * DeleteUserPushSubscription deletes a browser push subscription.
   *
   * @generated from rpc memos.api.v1.UserService.DeleteUserPushSubscription
   */
  deleteUserPushSubscription: {
    methodKind: "unary";
    input: typeof DeleteUserPushSubscriptionRequestSchema;
    output: typeof EmptySchema;
  },
  /**
   * TestUserPushNotification sends a test notification to the user's active browser subscriptions.
   *
   * @generated from rpc memos.api.v1.UserService.TestUserPushNotification
   */
  testUserPushNotification: {
    methodKind: "unary";
    input: typeof TestUserPushNotificationRequestSchema;
    output: typeof EmptySchema;
  },
}> = /*@__PURE__*/
