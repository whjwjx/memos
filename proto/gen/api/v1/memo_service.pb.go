...
type AutoTagMemoRequest struct {
	state protoimpl.MessageState `protogen:"open.v1"`
...
func (x *AutoTagMemoRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
type AutoTagMemoResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *AutoTagMemoResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
const file_api_v1_memo_service_proto_rawDesc = "" +
	...
	"\n" +
	"comment_id\x18\x03 \x01(\tB\x03\xe0A\x01R\tcommentId\"C\n" +
	"\x12AutoTagMemoRequest\x12-\n" +
	"\x04name\x18\x01 \x01(\tB\x19\xe0A\x02\xfaA\x13\n" +
	"\x11memos.api.v1/MemoR\x04name\"\x15\n" +
	"\x13AutoTagMemoResponse\"\xae\x01\n" +
	...
	"\x11CreateMemoComment\x12&.memos.api.v1.CreateMemoCommentRequest\x1a\x12.memos.api.v1.Memo\"?\xdaA\fname,comment\x82\xd3\xe4\x93\x02*:\acomment\"\x1f/api/v1/{name=memos/*}/comments\x12\x84\x01\n" +
	"\vAutoTagMemo\x12 .memos.api.v1.AutoTagMemoRequest\x1a!.memos.api.v1.AutoTagMemoResponse\"0\xdaA\x04name\x82\xd3\xe4\x93\x02#:\x01*\"\x1e/api/v1/{name=memos/*}:autoTag\x12\x91\x01\n" +
