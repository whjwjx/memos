...
type GeneralUserSetting struct {
	...
	// Defaults to true.
	ShowCommentPreview bool `protobuf:"varint,7,opt,name=show_comment_preview,json=showCommentPreview,proto3" json:"show_comment_preview,omitempty"`
...
func (x *GeneralUserSetting) GetShowCommentPreview() bool {
	if x != nil {
