...
const (
	...
	// Scheduled memo reminder notification.
	InboxMessage_SCHEDULE_REMINDER InboxMessage_Type = 3
)
...
func (x *InboxMessage) GetScheduleReminder() *InboxMessage_ScheduleReminderPayload {
	if x != nil {
		if x, ok := x.Payload.(*InboxMessage_ScheduleReminder); ok {
...
type InboxMessage_ScheduleReminder struct {
	ScheduleReminder *InboxMessage_ScheduleReminderPayload `protobuf:"bytes,4,opt,name=schedule_reminder,json=scheduleReminder,proto3,oneof"`
}
...
func (*InboxMessage_ScheduleReminder) isInboxMessage_Payload() {}
...
type InboxMessage_ScheduleReminderPayload struct {
	state                 protoimpl.MessageState `protogen:"open.v1"`
	MemoId                int32                  `protobuf:"varint,1,opt,name=memo_id,json=memoId,proto3" json:"memo_id,omitempty"`
	OccurrenceTime        int64                  `protobuf:"varint,2,opt,name=occurrence_time,json=occurrenceTime,proto3" json:"occurrence_time,omitempty"`
	ReminderOffsetSeconds int32                  `protobuf:"varint,3,opt,name=reminder_offset_seconds,json=reminderOffsetSeconds,proto3" json:"reminder_offset_seconds,omitempty"`
	unknownFields         protoimpl.UnknownFields
	sizeCache             protoimpl.SizeCache
}

func (x *InboxMessage_ScheduleReminderPayload) Reset() {
	*x = InboxMessage_ScheduleReminderPayload{}
	mi := &file_store_inbox_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *InboxMessage_ScheduleReminderPayload) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*InboxMessage_ScheduleReminderPayload) ProtoMessage() {}

func (x *InboxMessage_ScheduleReminderPayload) ProtoReflect() protoreflect.Message {
	mi := &file_store_inbox_proto_msgTypes[3]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use InboxMessage_ScheduleReminderPayload.ProtoReflect.Descriptor instead.
func (*InboxMessage_ScheduleReminderPayload) Descriptor() ([]byte, []int) {
	return file_store_inbox_proto_rawDescGZIP(), []int{0, 2}
}

func (x *InboxMessage_ScheduleReminderPayload) GetMemoId() int32 {
	if x != nil {
		return x.MemoId
	}
	return 0
...
func (x *InboxMessage_ScheduleReminderPayload) GetOccurrenceTime() int64 {
	if x != nil {
...
func (x *InboxMessage_ScheduleReminderPayload) GetReminderOffsetSeconds() int32 {
	if x != nil {
		return x.ReminderOffsetSeconds
	}
	return 0
}
...
const file_store_inbox_proto_rawDesc = "" +
	"\n" +
	"\x11store/inbox.proto\x12\vmemos.store\"\xf2\x05\n" +
	"\fInboxMessage\x122\n" +
	...
	"\x11schedule_reminder\x18\x04 \x01(\v21.memos.store.InboxMessage.ScheduleReminderPayloadH\x00R\x10scheduleReminder\x1aU\n" +
	...
	"\amemo_id\x18\x01 \x01(\x05R\x06memoId\x12&\n" +
	"\x0frelated_memo_id\x18\x02 \x01(\x05R\rrelatedMemoId\x1a\x93\x01\n" +
	"\x17ScheduleReminderPayload\x12\x17\n" +
	"\amemo_id\x18\x01 \x01(\x05R\x06memoId\x12'\n" +
	"\x0foccurrence_time\x18\x02 \x01(\x03R\x0eoccurrenceTime\x126\n" +
	"\x17reminder_offset_seconds\x18\x03 \x01(\x05R\x15reminderOffsetSeconds\"W\n" +
	"\x04Type\x12\x14\n" +
	"\x10TYPE_UNSPECIFIED\x10\x00\x12\x10\n" +
	"\fMEMO_COMMENT\x10\x01\x12\x10\n" +
	"\fMEMO_MENTION\x10\x02\x12\x15\n" +
	"\x11SCHEDULE_REMINDER\x10\x03B\t\n" +
	"\apayloadB\x95\x01\n" +
	"\x0fcom.memos.storeB\n" +
...
var file_store_inbox_proto_goTypes = []any{
	...
	(*InboxMessage_ScheduleReminderPayload)(nil), // 4: memos.store.InboxMessage.ScheduleReminderPayload
}
var file_store_inbox_proto_depIdxs = []int32{
	...
	4, // 3: memos.store.InboxMessage.schedule_reminder:type_name -> memos.store.InboxMessage.ScheduleReminderPayload
...
func file_store_inbox_proto_init() {
	...
	file_store_inbox_proto_msgTypes[0].OneofWrappers = []any{
		...
		(*InboxMessage_ScheduleReminder)(nil),
	}
	type x struct{}
